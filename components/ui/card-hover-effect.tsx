       ...
       key={item?.title}
        ...
        >
          <AnimatePresence>
            {hoveredIndex === idx && (
              <motion.span
                className="absolute inset-0 h-full w-full bg-[#120E1F] dark:bg-slate-800/[0.8] block  rounded-3xl"
          ...
          <Card >
            ...
            <CardDescription className="text-right">{item.description}</CardDescription>
          </Card>
        </div>
      ))}
    </div>
