  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        ...
        style={style}
      >
        <p className="absolute inset-x-2 text-sm md:text-xl text-center h-full break-words whitespace-pre-wrap text-white font-mono font-bold transition duration-500">
