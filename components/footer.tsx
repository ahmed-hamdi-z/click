              ...
              <li>
                ...
                >
                  ...
                  >
                    ...
                    <path
                      d="M18.5 188.7S72 163.9 72 80a56 56 0 0 1 112 0c0 83.9 53.5 108.7 53.5 108.7-9.3 8.7-29 3.4-40.2 9.5s-17 25.6-29.5 28.8-26.8-11-39.8-11-27.7 14.1-39.8 11-18.5-22.7-29.5-28.8-30.9-.8-40.2-9.5ZM189.3 122.7 216 112M66.7 122.7 40 112"
                      fill="none"
                      stroke="#ffffff"
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="mt-8 space-y-4 text-sm">
                ...
                <li>
                  <a
                    className="flex items-center justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end"
                    href="https://api.whatsapp.com/send/?phone=966544988088&text&type=phone_number&app_absent=0"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="size-5 shrink-0 text-[#F0C336]"
